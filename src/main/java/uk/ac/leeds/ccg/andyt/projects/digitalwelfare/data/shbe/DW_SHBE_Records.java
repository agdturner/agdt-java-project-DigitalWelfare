...
public class DW_SHBE_Records extends DW_Object implements Serializable {
    ...
    public DW_SHBE_Records(
        ...
        Records = getClaimIDToDW_SHBE_RecordMap(env.HandleOutOfMemoryError);
        ClaimIDsOfNewSHBEClaims = getClaimIDsOfNewSHBEClaims(env.HandleOutOfMemoryError);
        ClaimantPersonIDs = getClaimantPersonIDs(env.HandleOutOfMemoryError);
        PartnerPersonIDs = getPartnerPersonIDs(env.HandleOutOfMemoryError);
        NonDependentPersonIDs = getNonDependentPersonIDs(env.HandleOutOfMemoryError);
        CottingleySpringsCaravanParkPairedClaimIDs = getCottingleySpringsCaravanParkPairedClaimIDs(env.HandleOutOfMemoryError);
        ClaimIDsWithStatusOfHBAtExtractDateInPayment = getClaimIDsWithStatusOfHBAtExtractDateInPayment(env.HandleOutOfMemoryError);
        ClaimIDsWithStatusOfHBAtExtractDateSuspended = getClaimIDsWithStatusOfHBAtExtractDateSuspended(env.HandleOutOfMemoryError);
        ClaimIDsWithStatusOfHBAtExtractDateOther = getClaimIDsWithStatusOfHBAtExtractDateOther(env.HandleOutOfMemoryError);
        ClaimIDsWithStatusOfCTBAtExtractDateInPayment = getClaimIDsWithStatusOfCTBAtExtractDateInPayment(env.HandleOutOfMemoryError);
        ClaimIDsWithStatusOfCTBAtExtractDateSuspended = getClaimIDsWithStatusOfCTBAtExtractDateSuspended(env.HandleOutOfMemoryError);
        ClaimIDsWithStatusOfCTBAtExtractDateOther = getClaimIDsWithStatusOfCTBAtExtractDateOther(env.HandleOutOfMemoryError);
        SRecordsWithoutDRecords = getSRecordsWithoutDRecords(env.HandleOutOfMemoryError);
        ClaimIDAndCountOfRecordsWithSRecords = getClaimIDAndCountOfRecordsWithSRecords(env.HandleOutOfMemoryError);
        ClaimIDsOfClaimsWithoutAMappableClaimantPostcode = getClaimIDsOfClaimsWithoutAValidClaimantPostcode(env.HandleOutOfMemoryError);
        ClaimIDToClaimantPersonIDLookup = getClaimIDToClaimantPersonIDLookup(env.HandleOutOfMemoryError);
        ClaimIDToPartnerPersonIDLookup = getClaimIDToPartnerPersonIDLookup(env.HandleOutOfMemoryError);
        ClaimIDToDependentPersonIDsLookup = getClaimIDToDependentPersonIDsLookup(env.HandleOutOfMemoryError);
        ClaimIDToNonDependentPersonIDsLookup = getClaimIDToNonDependentPersonIDsLookup(env.HandleOutOfMemoryError);
        ClaimIDsOfClaimsWithClaimantsThatAreClaimantsInAnotherClaim = getClaimIDsOfClaimsWithClaimantsThatAreClaimantsInAnotherClaim(env.HandleOutOfMemoryError);
        ClaimIDsOfClaimsWithClaimantsThatArePartnersInAnotherClaim = getClaimIDsOfClaimsWithClaimantsThatArePartnersInAnotherClaim(env.HandleOutOfMemoryError);
        ClaimIDsOfClaimsWithPartnersThatAreClaimantsInAnotherClaim = getClaimIDsOfClaimsWithPartnersThatAreClaimantsInAnotherClaim(env.HandleOutOfMemoryError);
        ClaimIDsOfClaimsWithPartnersThatArePartnersInAnotherClaim = getClaimIDsOfClaimsWithPartnersThatArePartnersInAnotherClaim(env.HandleOutOfMemoryError);
        ClaimIDsOfClaimsWithNonDependentsThatAreClaimantsOrPartnersInAnotherClaim = getClaimIDsOfNonDependentsThatAreClaimantsOrPartnersInAnotherClaim(env.HandleOutOfMemoryError);
        ClaimantsInMultipleClaimsInAMonthPersonIDToClaimIDsLookup = getClaimantsInMultipleClaimsInAMonthPersonIDToClaimIDsLookup(env.HandleOutOfMemoryError);
        PartnersInMultipleClaimsInAMonthPersonIDToClaimIDsLookup = getPartnersInMultipleClaimsInAMonthPersonIDToClaimIDsLookup(env.HandleOutOfMemoryError);
        NonDependentsInMultipleClaimsInAMonthPersonIDToClaimIDsLookup = getNonDependentsInMultipleClaimsInAMonthPersonIDToClaimIDsLookup(env.HandleOutOfMemoryError);
        ClaimIDToPostcodeIDLookup = getClaimIDToPostcodeIDLookup(env.HandleOutOfMemoryError);
        ClaimIDToTenancyTypeLookup = getClaimIDToTenancyTypeLookup(env.HandleOutOfMemoryError);
        LoadSummary = getLoadSummary(env.HandleOutOfMemoryError);
        RecordIDsNotLoaded = getRecordIDsNotLoaded(env.HandleOutOfMemoryError);
        ClaimIDsOfInvalidClaimantNINOClaims = getClaimIDsOfInvalidClaimantNINOClaims(env.HandleOutOfMemoryError);
        ClaimantPostcodesUnmappable = getClaimantPostcodesUnmappable(env.HandleOutOfMemoryError);
        ClaimantPostcodesModified = getClaimantPostcodesModified(env.HandleOutOfMemoryError);
        ClaimantPostcodesCheckedAsMappableButNotInONSPDPostcodes = getClaimantPostcodesCheckedAsMappableButNotInONSPDPostcodes(env.HandleOutOfMemoryError);
        ClaimIDsOfClaimsWithClaimPostcodeFUpdatedFromTheFuture = getClaimIDsOfClaimsWithClaimPostcodeFUpdatedFromTheFuture(env.HandleOutOfMemoryError);
    }
