...
public abstract class DW_DensityMapsAbstract extends DW_Object {
    ...
    protected UKP_Data Postcode_Handler;
    ...
    protected int addFromPostcodes(Grids_GridDouble g, 
        ...
        UKP_YM3 nYM3 = Postcode_Handler.getNearestYM3ForONSPDLookup(yM3);
        ...
        while (itep.hasNext()) {
            ...
            if (aLSOACode != null) {
                int pl = Postcode_Handler.getPostcodeLevel(postcode);
                ONSPD_Point p = Postcode_Handler.getPointFromPostcode(
                        nYM3, pl, postcode);
                if (p != null) {
                    g.addToCell((double) p.getX(), (double) p.getY(), 1.0);
                } else {
